...
function startTLSServer(){
    const temp_tls = Object.assign({}, this.config.tls);
    if(temp_tls.key) {
        temp_tls.key = '#SECURE#';
    }
    if(temp_tls.cert) {
    ...
    this.log('starting TLS server',temp_tls);
    ...
    if(this.config.tls.dhparam && (typeof this.config.tls.dhparam === 'string') && !this.config.tls.dhparam.startsWith("-----BEGIN DH PARAMETERS-----")) {
